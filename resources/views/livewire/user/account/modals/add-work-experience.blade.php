<div 
    x-show="showAddWorkExperienceModal" 
    x-on:close-work-modal.window="showAddWorkExperienceModal = false"
    x-transition 
...
>
    <div class="relative p-4 w-full max-w-4xl bg-white rounded-lg shadow dark:bg-gray-700 max-h-[90vh] overflow-y-auto"
         @click.away="showAddWorkExperienceModal = false">
        ...
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-200 dark:border-gray-600">
            ...
            <button type="button" @click="showAddWorkExperienceModal = false"
            ...
            <div>
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <input type="text" id="company_name" wire:model="company_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        @error('company_name')
                    ...
                    <div x-data="{ current: @entangle('is_current'), 
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div class="col-span-1">
                                <input id="is_current_work" x-model="current" wire:model="is_current" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="is_current_work" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Currently working here?</label>
                            </div>
                        </div>
                    </div>
                    {{-- ----------------------------------------------------------------------------------------------------------- --}}
